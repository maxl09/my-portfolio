...
const About = () => {
    return (
        <Container id="about" sx={{ padding: { xs: 5, sm: 20 }, height: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center' }} data-aos="fade-right">
            ...
            <Typography sx={{ typography: { xs: 'body2', md: 'h6' }, marginTop: 3 }} color="inherit">
                In addition to front-end development, I’ve expanded my skill set through <span style={{ fontWeight: 700 }}>personal full-stack projects</span> utilizing <span style={{ fontWeight: 700 }}>Node.js, Express.js, and MongoDB</span>, where I’ve designed and implemented RESTful APIs, managed database schemas, and handled backend integrations to create seamless end-to-end web applications.
            </Typography>
